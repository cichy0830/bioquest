const units = [
  ...
  { title: "人體心血管系統的組成", unitId: "cardiovascular_components", status: "ready", sequence: 18, summary: "正式順序第十八單元。手機優先功能原型已可測試，含心臟、血管、血液成分、脈搏血壓與合作流程排序；正式視覺素材待核准後接線。", tags: ["可測試", "心血管", "血液", "後台驗證"], url: "prototype-cardiovascular-components/?v=20260720-cardiovascular-components-brief-scroll-v1&title=20260720-title-next-progress-v1" },
  { title: "人體的循環系統", unitId: "human_circulation", status: "ready", sequence: 19, summary: "正式順序第十九單元。手機優先功能原型已可測試，含體循環、肺循環、含氧量變化、微血管交換與組織液/淋巴基礎；正式視覺素材待核准後接線。", tags: ["可測試", "循環", "體循環", "肺循環", "後台驗證"], url: "prototype-human-circulation/?v=20260720-human-circulation-evidence-v1&title=20260720-title-next-progress-v1" },
