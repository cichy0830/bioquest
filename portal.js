const units = [
  ...
  { title: "刺激與反應", unitId: "stimulus_response", status: "ready", sequence: 20, summary: "正式順序第二十單元。手機優先功能原型已可測試，含刺激/反應辨識、受器與動器、基本流程、反應時間資料判讀與公平測量。", tags: ["可測試", "刺激", "反應", "受器", "反應時間"], url: "prototype-stimulus-response/?v=20260720-stimulus-response-readiness-v1&title=20260720-title-next-progress-v1" },
