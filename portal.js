const units = [
  {
    ...
    tags: ["正式原型", "生命現象", "已可測試"],
    aliases: ["多采多姿的生命世界"],
    url: "prototype-life-world/?v=20260711-badge-layout-v5"
  },
  {
    title: "探究自然的科學方法",
    ...
    tags: ["正式原型", "科學方法", "已可測試"],
    url: "prototype-scientific-method/?v=20260711-badge-layout-v5"
  },
  {
    title: "進入實驗室",
    unitId: "lab_intro",
    ...
    tags: ["正式原型", "實驗安全", "已可測試"],
    url: "prototype-lab-entry/?v=20260711-badge-layout-v5"
  },
  {
    title: "顯微鏡的使用",
    ...
    tags: ["正式原型", "顯微鏡", "已可測試"],
    url: "prototype-microscope-use/?v=20260711-microscope-brief-checkpoint-v1"
  },
  {
    title: "生物體的基本單位",
  ...
  { title: "細胞的構造", unitId: "cell_structure", status: "ready", sequence: 6, summary: "已有模板驗證原型，具細胞圖、構造高亮、配對、比較、EXP 明細與徽章。", tags: ["模板驗證", "細胞構造", "已可測試"], url: "prototype-cell-structure/?v=20260711-badge-layout-v5", note: "模板驗證單元" },
