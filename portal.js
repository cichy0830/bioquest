const units = [
  ...
  },
  {
    ...
    tags: ["正式原型", "細胞", "已可測試"],
    url: "prototype-cell-basic-unit/?v=20260721-cell-basic-unit-required-gates-v1&title=20260720-title-next-progress-v1"
  },
  { title: "細胞的構造", unitId: "cell_structure", status: "ready", sequence: 6, summary: "已有模板驗證原型，具細胞圖、構造高亮、配對、比較、EXP 明細與徽章；正式登入已接 server_verified canonical。", tags: ["模板驗證", "細胞構造", "已可測試"], url: "prototype-cell-structure/?v=20260721-cell-structure-scrolltop-v1&title=20260720-title-next-progress-v1", note: "模板驗證單元" },
  ...
  { title: "物質進出細胞的方式", unitId: "cell_transport", status: "ready", sequence: 8, summary: "正式順序第八單元。已完成學生端靜態原型，含擴散與滲透、半透膜、濃度方向、資料判讀與動植物細胞變化。", tags: ["正式原型", "擴散", "滲透", "已可測試"], url: "prototype-cell-transport/?v=20260721-cell-transport-q07-inactive-cache-v1&title=20260720-title-next-progress-v1" },
  ...
  { title: "植物如何製造養分", unitId: "photosynthesis", status: "ready", sequence: 14, summary: "正式順序第十四單元。已完成學生端靜態原型，含原料/能量/產物分類、葉片構造、澱粉與氣泡證據、變因判讀及光合作用/呼吸作用迷思修正。", tags: ["正式原型", "光合作用", "葉綠體", "變因判讀", "已可測試"], url: "prototype-photosynthesis/?v=20260721-photosynthesis-q09-inactive-cache-v1&title=20260720-title-next-progress-v1" },
  ...
  { title: "刺激與反應", unitId: "stimulus_response", status: "ready", sequence: 20, summary: "正式順序第二十單元。手機優先功能原型已可測試，含刺激/反應辨識、受器與動器、基本流程、反應時間資料判讀與公平測量。", tags: ["可測試", "刺激", "反應", "受器", "反應時間"], url: "prototype-stimulus-response/?v=20260721-stimulus-response-badges-b-v1&title=20260720-title-next-progress-v1" },
