...
const verifiedSnapshotKey = "bioquest_behavior_sensing_verified_snapshot_v1";
...
const assets = {
  ...
  briefingSceneHook: `assets/behavior-sensing-briefing-azhe-wide.webp?v=${VERSION}`,
...
function buildBackendPayload(result = scoreAttempt()) {
  ...
  result.logs.forEach((log) => {
    ...
    if (shortId) rawAnswers[shortId] = log.answer;
  });
  return {
