...
const VERSION = "20260711-nutrients-energy-v1";
...
function attachQuestionEvents() {
  ...
  document.querySelectorAll("[data-multi]").forEach((button) => button.addEventListener("click", () => {
    ...
    if (!multiSelectQuestions[qid].answers.includes(value)) markHint(qid);
    saveState(); render();
  }));
  document.querySelectorAll("[data-classify-question]").forEach((select) => select.addEventListener("change", () => {
