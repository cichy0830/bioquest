...
assert.equal(api.VERSION, "20260720-plant-transport-structures-extension-v2");
...
for (const qid of ["q01", "q04", "q05", "q06", "q07", "q09", "q10", "q11", "q12"]) assert.equal(api.renderQuestionEvidence(qid), "", qid);
