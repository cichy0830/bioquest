...
const sharedVersionOverrides = new Map([
  ...
  ["prototype-plant-material-transport", "20260720-plant-material-transport-canonical-v1"],
  ["prototype-cardiovascular-components", "20260720-cardiovascular-components-converge-v1"],
