...
appVersionOverrides.set("cell_observation", "20260716-cell-observation-achievement-overview-v1");
...
sharedCacheOverrides.set("cell_observation", "20260716-cell-observation-achievement-overview-v1");
...
const audit = units.map(([unitId, folder]) => {
  ...
  if (unitId === "cell_observation") {
    assert(index.includes("styles.css?v=20260716-cell-observation-achievement-overview-v1"), "cell_observation style cache bust missing");
  }
